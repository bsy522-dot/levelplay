...
const V6_QUIZZES=[
  {q:'소수(Prime)의 정의는?',a:['1과 자기 자신만으로 나누어지는 수','짝수가 아닌 수','10보다 큰 수','음수가 아닌 수'],c:0,cat:'수학'},
  {q:'원의 넘이 공식은?',a:['πr²','2πr','πd','r²/2'],c:0,cat:'수학'},
  ...
  {q:'독립문을 작성한 사람은?',a:['최남선','이봉창','안창호','윤봉길'],c:0,cat:'한국사'},
  ...
  {q:'알레그로(allegro)의 볠늘?',a:['빠르게','느리게','여리게','세게'],c:0,cat:'음악'},
  ...
  {q:'수채화의 대표적인 미술 기법은?',a:['숙치면화','유화','판화','프레스코화'],c:0,cat:'미술'},
  {q:'색의 3원색은?',a:['빨강/파랑/노랑','빨강/초록/파랑','빨강/보라/노랑','파랑/초록/보라'],c:0,cat:'미술'},
  {q:'로덴의 “생각하는 사람”은 어느 장르의 작품인가?',a:['조각','회화','판화','부조'],c:0,cat:'미술'},
  ...
  {q:'성덕대왕이 세운 허와는?',a:['수원화성','경복궁','불국사','해인사'],c:0,cat:'한국사'}
];
