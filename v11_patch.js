...
const AQ_POOL=[
  ...
  {q:'DNA의 이중나선 구조 발견자는?',a:['왔슨과 크릭','멘델','다윈','파스퇼르'],c:0,d:2,cat:'과학'},
  ...
  {q:'영어 문장에서 관사 a/an의 콜론 위치는?',a:['명사 앞','동사 앞','부사 앞','접속사 앞'],c:0,d:0,cat:'영어'},
  ...
  {q:'현악기 중 현이 4개인 것은?',a:['바이올린','콘트라바스','첼로','비올라'],c:0,d:2,cat:'음악'},
...
const V11_QUIZ=[
  ...
  {q:'멜타인지는 무엇에 대한 인지?',a:['자신의 사고과정','타인의 감정','사회적 관계','언어 구조'],c:0,cat:'v11학습법'},
  {q:'인출 연습이 재인출보다 효과적인 이유는?',a:['기억 경로 강화','시간 절약','즉각적 피드백','스트레스 감소'],c:0,cat:'v11학습법'},
  {q:'학습 픻C라미드의 바닥은?',a:['기억하기','창조하기','이해하기','분석하기'],c:0,cat:'v11학습법'},
