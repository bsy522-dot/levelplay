...
const CONTEST_QUESTIONS=[
  ...
  {q:'옥타브 음계의 음 수는?',opts:['8음','7음','12음','5음'],ans:0,subj:'음악'},
  {q:'빨강과 노랑 혼합 시 색상은?',opts:['주황색','보라색','녹색','갈색'],ans:0,subj:'미술'},
...
function injectV12Quiz(){
  ...
  window.addQuizQuestions([
    ...
    {q:'퀴즈 난이도 티어 중 최고 등급은?',o:['Grandmaster','Master','Diamond','Champion'],a:0,cat:'학습법'},
