...
const V5_QUIZZES=[
  ...
  {q:'독립협회를 설립한 사람은?',a:['안창호','김구','이봉창','윤봉길'],c:0,cat:'한국사'},
  ...
  {q:'비바디의 사계 중 “봄”은?',a:['La Primavera','Winter','Autumn','Summer'],c:0,cat:'음악'},
  {q:'오카리나는 어느 나라 악기?',a:['하와이','이탈리아','프랑스','중국'],c:0,cat:'음악'},
  {q:'음악에서 “piano”의 뜻은?',a:['여리게','세게','빠르게','느리게'],c:0,cat:'음악'},
  {q:'피겨 스케이팅에서 트리플 액셀은 몇 바퀴 반?',a:['3바퀴 반','2바퀴 반','4바퀴 반','1바퀴 반'],c:0,cat:'체육'},
  {q:'올림픽 검도의 국가별 최대 참가 선수는?',a:['3명','5명','1명','10명'],c:0,cat:'체육'},
  {q:'수영에서 버터플라이 영법의 특징은?',a:['양팔을 번갈아 저음','다리만 사용','배영','평영'],c:0,cat:'체육'},
